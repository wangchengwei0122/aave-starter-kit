            ...
            <div className="flex items-center space-x-3">
              <Popover open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
                <PopoverTrigger asChild>
                  <Button
                    variant="ghost"
                    className="flex items-center space-x-2 text-lg font-semibold hover:bg-gray-100"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-gray-900">
                {userPosition ? formatCurrency(userPosition.netWorth) : '$0.00'}
              </div>
            </div>

            {/* 净APY */}
            <div className="text-center">
              <div className="text-sm text-gray-600 mb-1">Net APY</div>
              <div
                className={`text-2xl font-bold flex items-center justify-center ${getAPYColor(userPosition?.netAPY || 0)}`}
              >
                {userPosition ? (
                  <>
            ...
            <div className="text-center">
              ...
              <div
                className={`text-2xl font-bold flex items-center justify-center ${getHealthFactorColor(userPosition?.healthFactor || 0)}`}
              >
                <Shield className="h-5 w-5 mr-1" />
                {userPosition ? userPosition.healthFactor.toFixed(2) : '0.00'}
              </div>
